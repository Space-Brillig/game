...
class Spaceship(pygame.sprite.Sprite):
    ...
    def update(self, SURFACE_HEIGHT, SURFACE_WIDTH, SURFACE):
        ...
        if (key[pygame.K_a] or key[pygame.K_LEFT]) and self.rect.left > 10:
            self.rect.x -= speed
        if (key[pygame.K_s] or key[pygame.K_DOWN]) and self.rect.bottom < SURFACE_HEIGHT - 10:
            self.rect.y += speed
...
class Alien(pygame.sprite.Sprite):
    ...
    def update(self, SURFACE_WIDTH, SURFACE_HEIGHT):
        self.rect.y += 4
...
class Meteor(pygame.sprite.Sprite):
    ...
    def update(self, SURFACE_HEIGHT, spaceship):
        self.rect.y += 10
